  ...
  async fetchUserData() {
    try {
      ...
      this.userData = {
        ...
        address:data.userData.wallet.address,
        ...
        latestLevel: {
          ...
          upgradeLevel: data.userData.level,
        ...
        referralLink:
          data.userData.referralLink || "https://abcdjjj.in/egister/AB4",
        contractAddress:
          data.userData.contractAddress || "https://abcdjjj.in/egister/AB4",
      };
    } catch (error) {
